    ...
    return quintas.filter((quinta: Quintas) => {
      return (
        ...
        (filters.currency_price === "TODAS" ||
          quinta.currency_price === filters.currency_price) &&
        filters.priceRange[0] <= quinta.price &&
        ...
        (filters.mantas === null ||
          filters.mantas === false ||
          quinta.mantas === true) &&
        (filters.parrilla === null ||
          filters.parrilla === false ||
          quinta.parrilla === true) &&
        (filters.piscina === null ||
          filters.piscina === false ||
          quinta.piscina === true) &&
        (filters.playroom === null ||
          filters.playroom === false ||
