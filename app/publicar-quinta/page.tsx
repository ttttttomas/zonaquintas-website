...
export default function PublicarQuintaPage() {
  return (
    <main className="flex flex-col relative items-center justify-center">
      ...
      <h1 className="text-center text-primaryDark font-extrabold text-xl md:text-2xl">Bienvenido/a a la sección de Propietarios</h1>
      <h2 className="text-center text-primaryDark font-semibold md:text-xl mb-5">Los pasos para el alquiler de tu Quinta</h2>
      <SecondSeparator />
