...
export default function MembershipPage() {
  return (
    <main className="min-h-screen pb-20 px-4 md:px-10 max-w-7xl mx-auto animate-in fade-in duration-700">
      ...
      {/* Promotion Banner */}
      <section className="bg-primaryDark/10 border-2 border-primaryDark rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden group">
      ...
      <section className="flex justify-around gap-8 mb-20">
        ...
        {/* Tier Premium */}
        <div className="bg-gray-900 rounded-3xl hover:-translate-y-4 p-8 shadow-2xl flex flex-col text-white hover:shadow-primaryDark/20 transition-all duration-300">
          <div className="mb-6">
          ...
          <button className="w-full py-4 rounded-xl cursor-pointer bg-white text-gray-900 font-semibold hover:bg-gray-100 transition-colors">
            Pasar a Premium
          </button>
        </div>
      </section>
